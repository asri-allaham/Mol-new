                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ProjectImagesCarousel(
                              imageUrls:
                                  List<String>.from(project['image_urls']))
                        ],
                      ),
                      ...
                      Align(
                        ...
                        child: TextButton.icon(
                          ...
                          icon: Icon(
                            isFavorited != null || isFavorited == true
                                ? Icons.favorite
                                : Icons.favorite_border,
                            color: isFavorited != null || isFavorited == true
                                ? Colors.red
                                : Colors.grey,
                          ),
                          label: Text(
                              ...
                              ...(() {
                                final ratingData = ratings.map((ratingItem) {
                                  ...
                                  return {
                                    ...
                                    'timestamp': ratingItem['timeOfRating']
                                        as Timestamp?,
                                    'userUid': userUid,
                                  };
                                }).toList();
                                            ...
                                            child: FutureBuilder(
                                              ...
                                              builder: (context,
                                                ...
                                                final username = snapshot
                                                        .data?[0] as String? ??
                                                    'Unknown user';
                                                final userUrl = snapshot
                                                    .data?[1] as String?;

                                                int ratingNumber =
                                                    ratingItem['Starnumber'] ??
                                                        0;
                                                final comment =
                                                    ratingItem['comment'] ?? "";
